...
func NewRootCmd() *cobra.Command {
	...
	root.PersistentFlags().BoolVar(&opts.JSON, "json", true, "Output JSON")
	...
	root.PersistentFlags().BoolVar(&opts.EnableCallback, "enable-callback", true, "Enable x-callback handling")
